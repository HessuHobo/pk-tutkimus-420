<?
define(TITLE, 'PK-BOARD-SAATANA');		//Name of this image board
define(SQLLOG, 'swag');		//Table (NOT DATABASE) used by image board
define(SQLHOST, 'localhost');		//MySQL server address, usually localhost
define(SQLUSER, 'jumala');		//MySQL user (must be changed)
define(SQLPASS, 'kebab420');		//MySQL user's password (must be changed)
define(SQLDB, 'MySQL');		//Database used by image board
define(ADMIN_PASS, 'kebab420');	//Janitor password  (CHANGE THIS YO)
